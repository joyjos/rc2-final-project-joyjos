  ...
  return (
    <main className="ae-container-fluid ae-container-fluid--inner rk-main legal animated fadeIn">
      <div className="justify">
        ...
        <p className="au-mb-3">
          Este sitio web usa Cookies para mejorar y optimizar la experiencia del
          usuario. A continuación encontrarás información detallada sobre qué
          son las "Cookies", qué tipología utiliza este sitio web, cómo puedes
          desactivarlas en tu navegador y cómo bloquear específicamente la
          instalación de Cookies de terceros.
        </p>
        <h3>1.- Qué son las Cookies</h3>
        <p className="au-mb-3">
          Las Cookies son archivos que el sitio web o la aplicación que utilizas
          instala en tu navegador o en tu dispositivo (Smartphone, tableta o
          televisión conectada) durante tu recorrido por las páginas o por la
          aplicación, y sirven para almacenar información sobre tu visita.
        </p>
        <h3>2.- Qué tipos de Cookies utiliza esta Web</h3>
        <h4 className="cookies">Cookie Consent</h4>
        <p className="au-mb-3">
          Esta cookie se utiliza para recordar si ha dado su consentimiento para
          el uso de cookies en este sitio web. Cuando da su consentimiento, se
          establece una cookie que evita que aparezca la barra de notificación
          de cookies en la parte inferior de la ventana del navegador.
        </p>
        ...
        <p className="au-mb-3">
          Son las que permanecen en el ordenador del usuario aunque este cierre
          el navegador. Solo se eliminan cuando expira su tiempo de permanencia
          (que suele ser muy largo), cuando cumplen su función, o cuando se
          borran manualmente.
        </p>
        <h4 className="cookies">Cookies de Análisis</h4>
        <p className="au-mb-3">
          Este tipo de cookies, normalmente se generan a través de un proveedor
          externo (como pueden ser Google Analytics, Comscore, Netscope, etc.) y
          básicamente su finalidad es identificar al usuario de forma anónima
          para poder analizar pautas de comportamiento de los usuarios mientras
          navegan por la web.
        </p>
        <p className="au-mb-3">
          ...
          con el objetivo de recabar datos estadísticos que permitan mejorar la
        ...
        <p className="au-mb-3">
          ...
          usuario puede no ser óptima y algunas utilidades pueden no funcionar.
        </p>
